...
export type ApiBuyListImportResult = components["schemas"]["BuyListImportResponseDto"];
...
export type ApiDeckSummary = components["schemas"]["DeckSummaryApiDto"];
export type ApiDeckDetail = components["schemas"]["DeckDetailApiDto"];
export type ApiDeckCard = components["schemas"]["DeckCardApiDto"];
export type ApiDeckCreate = components["schemas"]["DeckCreateApiDto"];
export type ApiDeckUpdate = components["schemas"]["DeckUpdateApiDto"];
export type ApiDeckImport = components["schemas"]["DeckImportApiDto"];
export type ApiDeckImportResult = components["schemas"]["DeckImportApiResultDto"];
export type DeckFormat = NonNullable<ApiDeckCreate["format"]>;
